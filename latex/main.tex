...
If you are looking for the sensordata from the system's sensors, this is what you are looking for.
\\
...
After an option on the sidebar was chosen, the map will change accordingly.
\\
...
\\
This page is used when an admin wants to make changes to sensorhubs and/or user accounts.
\\
